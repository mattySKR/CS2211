// Name of the program: datatype.h
// Program description: head file for datatype.c
// Author: Matvey Skripchenko

#ifndef ASSIGNMENT5_DATATYPE_H
#define ASSIGNMENT5_DATATYPE_H
#endif //ASSIGNMENT5_DATATYPE_H
